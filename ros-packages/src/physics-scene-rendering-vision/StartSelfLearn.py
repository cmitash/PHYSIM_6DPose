...
def draw_bboxes(begin, syn_images_folder):
    ...
    for i in range(begin, end):
        ...
        im_real = Image.open(real_img_filepath)
        draw_real = ImageDraw.Draw(im_real)
        ...
        for k in range(len(bbox_list)-1,-1,-1):
            ...
            if maxcontourarea > 50:
                ...
                draw_real.rectangle([(x1, y1), (x1 + w1, y1 + h1)], outline=(255,0,0,255))
        ...
        new_img_filepath = osp.join(syn_images_folder, 'dbg_real_img_%05d.png' % i)
        im_real.save(new_img_filepath)
