...
while True:
    ...
    # get camera location
    cam_location = [0.3, -0.15, 1.0]
    cam_rotation = [0.641, 0.299, -0.299, -0.641]
    ...
    for i in range(0, numberOfObjects):
        ...
        with open(final_pose_file, "a+") as file:
            file.write("%s %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f\n" % ( pose_list[i][0],
                                            ...
                                            objects[shape_file].matrix_world[0][3], 
                                            objects[shape_file].matrix_world[1][0],
                                            objects[shape_file].matrix_world[1][1],
                                            objects[shape_file].matrix_world[1][2], 
                                            objects[shape_file].matrix_world[1][3],
