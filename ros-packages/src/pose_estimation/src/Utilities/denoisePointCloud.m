function [objSegmPts, allCamColors] = denoisePointCloud(objSegmPts, allCamColors)
...
allCamColors = allCamColors(:,find((currObjSegPtsDistPC1 > PC1Range(1)) & (currObjSegPtsDistPC1 < PC1Range(2)) & ...
                             (currObjSegPtsDistPC2 > PC2Range(1)) & (currObjSegPtsDistPC2 < PC2Range(2)) & ...
                             (currObjSegPtsDistPC3 > PC3Range(1)) & (currObjSegPtsDistPC3 < PC3Range(2))));
end
