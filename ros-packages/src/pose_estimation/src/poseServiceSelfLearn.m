function resp = poseServiceSelfLearn(~, reqMsg, respMsg)
...
D_name = [repo_path, '/ros-packages/src/physics-scene-rendering-vision/rendered_images/image_*'];
D = dir(D_name);
numfilespresent = length(D(not([D.isdir])));
