classdef ObjectPose < robotics.ros.Message
    %ObjectPose MATLAB implementation of pose_estimation/ObjectPose
    ...
    properties (Constant)
        MessageType = 'pose_estimation/ObjectPose' % The ROS message type
    end
    
    properties (Constant, Hidden)
        MD5Checksum = '9c3f82e0386cdc62646fa06389817172' % The MD5 Checksum of the message definition
    end
    ...
    properties (Constant, Hidden)
        PropertyList = {'Label', 'Pose'} % List of non-constant message properties
        ROSPropertyList = {'label', 'pose'} % List of non-constant ROS message properties
    end
    ...
    methods
        ...
        function set.Label(obj, label)
            ...
            validateattributes(label, {'char'}, {}, 'ObjectPose', 'Label');
    ...
    methods (Static, Access = {?matlab.unittest.TestCase, ?robotics.ros.Message})
        function obj = loadobj(strObj)
            ...
            if isempty(strObj)
                obj = robotics.ros.custom.msggen.pose_estimation.ObjectPose.empty(0,1);
                return
            end
            
            % Create an empty message object
            obj = robotics.ros.custom.msggen.pose_estimation.ObjectPose;
            obj.reload(strObj);
        end
    end
end
