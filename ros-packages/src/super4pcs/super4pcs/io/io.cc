...
////////////////////////////////////////////////////////////////////////////////
PQP_Model * 
IOManager::ReadPQPModel(const char *name)
{
  ...
  ReadObject(name,v,tex_coords,normals,tris,mtls);
  ...
  for(int i=0; i<tris.size(); ++i){
    tripple triangle = tris[i];
    
    PQP_REAL p1[3], p2[3], p3[3];
    p1[0] = v[triangle.a - 1].x;
    p1[1] = v[triangle.a - 1].y;
    p1[2] = v[triangle.a - 1].z;
    p2[0] = v[triangle.a - 1].x;
    p2[1] = v[triangle.a - 1].y;
    p2[2] = v[triangle.a - 1].z;
    p3[0] = v[triangle.a - 1].x;
    p3[1] = v[triangle.a - 1].y;
    p3[2] = v[triangle.a - 1].z;
...
// bool 
// IOManager::LoadCollisionEnv()
// {
//   std::string shelf_base = "";
//   ReadPQPModel();
// }
////////////////////////////////////////////////////////////////////////////////
/// Read
