...
std::string shelf_net_arch_filename = "/home/pracsys/github/apc-vision-toolbox/ros-packages/catkin_ws/src/marvin_convnet/models/competition/net.json";
std::string tote_net_arch_filename = "/home/pracsys/github/apc-vision-toolbox/ros-packages/catkin_ws/src/marvin_convnet/models/competition/net.json";
std::string shelf_net_weights_filename = "/home/pracsys/github/apc-vision-toolbox/ros-packages/catkin_ws/src/marvin_convnet/models/competition/weights_shelf.marvin";
std::string tote_net_weights_filename = "/home/pracsys/github/apc-vision-toolbox/ros-packages/catkin_ws/src/marvin_convnet/models/competition/weights_tote.marvin";
...
bool srv_detect(marvin_convnet::DetectObjects::Request  &req,
  ...
  std::cout<<"req :"<<bin_id<<" "<<frame_id<<std::endl;
  // Get frame filenames
  ...
  std::cout<<color_frame_filename<<std::endl;
