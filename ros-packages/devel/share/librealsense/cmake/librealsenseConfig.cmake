...
if("TRUE" STREQUAL "TRUE")
  set(librealsense_SOURCE_PREFIX /home/pracsys/github/PHYSIM_6DPose/ros-packages/src/librealsense)
  set(librealsense_DEVEL_PREFIX /home/pracsys/github/PHYSIM_6DPose/ros-packages/devel)
  ...
  set(librealsense_INSTALL_PREFIX /home/pracsys/github/PHYSIM_6DPose/ros-packages/install)
...
if(NOT "/home/pracsys/github/PHYSIM_6DPose/ros-packages/src/librealsense/include " STREQUAL " ")
  set(librealsense_INCLUDE_DIRS "")
  set(_include_dirs "/home/pracsys/github/PHYSIM_6DPose/ros-packages/src/librealsense/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'librealsense' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pracsys/github/PHYSIM_6DPose/ros-packages/src/librealsense/${idir}'.  Ask the maintainer 'Sergey Dorodnicov <sergey.dorodnicov@intel.com>, Mark Horn <mark.d.horn@intel.com>, Reagan Lopez <reagan.lopez@intel.com>' to fix it.")
    endif()
